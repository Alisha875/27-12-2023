...
namespace Assignment.Controllers
{
    public class TechnologiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CId,Technology1")] Technology technology)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CId,Technology1")] Technology technology)
        {
            if (ModelState.IsValid)
            {
